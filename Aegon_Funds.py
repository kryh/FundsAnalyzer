...
if __name__ == "__main__":
	...
	for f in FundIndicators[0:8]:
		...
		#plt.plot(f[6], label=f[0] + ", " + str( f[1]))
		plt.plot(f[6], label="{fundName},  Return: {totalRet:.2%}".format(fundName=f[0], totalRet=f[1]))
